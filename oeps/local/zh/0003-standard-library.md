...
同时定义 macro phase boundary、显式 core import、sequence semantic、type/contract
...
### 显式 core import contract

**OEP-0003-R020：** 普通 Osiris module 必须显式 import 所使用的每个 `osiris.core`
binding。Compiler 不得通过 implicit/automatic refer policy 使 `osiris.core` binding 可见。
...
**OEP-0003-R024：** 规范性的全 core import 形式是：
