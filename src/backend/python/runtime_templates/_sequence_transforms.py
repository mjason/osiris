...
from ._logical import logical_equal as _clojure_equal
...
def _sequence_count(value: object, name: str) -> int:
...
def take(amount: int, collection: object) -> _LazySeq:
    ...
    amount = _sequence_count(amount, "take")
...
def drop(amount: int, collection: object) -> _LazySeq:
    ...
    amount = _sequence_count(amount, "drop")
